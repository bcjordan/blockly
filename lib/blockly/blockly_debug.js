...
Blockly.FieldRectangularDropdown.prototype.addPositionAndShowMenu = function(menu) {
  ...
  var menuPosition = this.calculateMenuPosition_(this.previewElement_);
  Blockly.WidgetDiv.position(menuPosition.x, menuPosition.y, windowSize, scrollOffset);
  widgetDiv.style.visibility = "visible"
};
Blockly.FieldRectangularDropdown.prototype.calculateMenuPosition_ = function(dropdownTargetElement) {
...
Blockly.FieldRectangularDropdown.prototype.onMouseUp_ = function(e) {
  ...
  if(Blockly.isRightButton(e) || Blockly.Block.isFreelyDragging()) {
    return
  }
  this.showMenu_()
};
...
Blockly.FieldRectangularDropdown.prototype.calculateBackdropColourWithoutAlpha_ = function() {
  var blockColour = Blockly.makeColour(this.sourceBlock_.getColour(), this.sourceBlock_.getSaturation(), this.sourceBlock_.getValue());
...
goog.require("Blockly.FieldRectangularDropdown");
goog.require("Blockly.ImageDimensionCache");
Blockly.FieldImageDropdown = function(choices) {
...
Blockly.FieldImageDropdown.prototype.addPreviewElementTo_ = function(parentElement) {
  this.previewElement_ = Blockly.createSvgElement("image", {"height":Blockly.FieldImage.IMAGE_LOADING_HEIGHT + "px", "width":Blockly.FieldImage.IMAGE_LOADING_WIDTH + "px", "y":Blockly.FieldImage.IMAGE_OFFSET_Y}, parentElement)
};
...
Blockly.FieldImageDropdown.prototype.createDropdownPreviewElement_ = function(previewData) {
  var dropdownPreviewElement = document.createElement("img");
  dropdownPreviewElement.setAttribute("src", previewData);
...
"}", ".blocklySelected:not(.blocklyUndraggable)>.blocklyPath {", "  stroke-width: 3px;", "  stroke: #fc3;", "}", ".blocklySelected:not(.blocklyUndraggable)>.blocklyPathLight {", "  display: none;", "}", ".blocklyUndraggable>.blocklyEditableText>rect {", "  fill-opacity: 1.0;", "  fill: #ffdb74;", "}", ".blocklyDragging>.blocklyPath,", ".blocklyDragging>.blocklyPathLight {", "  fill-opacity: 0.8;", "  stroke-opacity: 0.8;", "}", ".blocklyDragging>.blocklyPathDark {", "  display: none;", "}", ".blocklyDisabled>.blocklyPath {", 
...
Blockly.parseOptions_ = function(options) {
  ...
  return{RTL:!!options["rtl"], collapse:hasCollapse, readOnly:readOnly, maxBlocks:options["maxBlocks"] || Infinity, assetUrl:options["assetUrl"] || function(path) {
    return"./" + path
  }, hasCategories:hasCategories, hasScrollbars:hasScrollbars, hasConcreteBlocks:hasConcreteBlocks, hasTrashcan:hasTrashcan, varsInGlobals:varsInGlobals, languageTree:tree}
};
